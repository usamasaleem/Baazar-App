...
import SideNav from '../orderManagement/sidenav'
        ...
        return (
            ...
            <Section>
                ...
                <MainContainer>
                    ...
                    <Orders>
                        <MainHeading>Walk In</MainHeading>
                        <CardContainer>
                    <Title>
                            <Heading  style={{ paddingTop:"20px"}}>Products</Heading>
                           
                        </Title>

                        {this.state.orders.map((item) => 
                      <Cards item={item} value={item}></Cards>
