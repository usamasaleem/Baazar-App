...
import Card from '../components/paymentCard/StoreCard'
...
class payment extends Component {
    ...
    componentDidMount() {
      ...
      getPayable(){
        ...
        const url = 'http://localhost:4000/payable/'+id;
            const config = {
                headers: {
       ...
       <>
            <Section>
                ...
                <Products>
                    ...
                    <CardText className="CardText">Store ID</CardText>
                    <CardText className="CardText">Order ID</CardText>
                    <CardText className="CardText">Payable</CardText>
